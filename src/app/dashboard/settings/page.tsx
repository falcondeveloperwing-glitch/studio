      ...
      <Tabs defaultValue="general" className="w-full" value={activeTab} onValueChange={setActiveTab}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
              ...
              <div className="space-y-6">
                <GlassCard className="border-white/5 bg-zinc-950/50 p-8">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    {!isAdmin && <Badge variant="outline" className="ml-auto bg-zinc-900/50 text-[9px] uppercase tracking-tighter text-zinc-500 gap-1.5"><Lock size={10}/> Locked</Badge>}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <Input 
                        disabled={!isAdmin}
                        className="bg-white/5 border-white/10 rounded-lg h-11 text-white disabled:opacity-40 disabled:cursor-not-allowed" 
            ...
            {/* Other tabs follow the same role-based visibility already implemented */}
          </motion.div>
        </AnimatePresence>
      </Tabs>
    </div>
